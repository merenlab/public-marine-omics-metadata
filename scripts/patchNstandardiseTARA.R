...
# Rename size fraction thresholds and concatenate into size_frac
TARA_patch2 <- TARA_patch2 %>%
  rename(
...
# remove any rows that have temperature_degC = 99999
library(dplyr)

# Remove rows where temperature_degC equals 99999
TARA_patch2[TARA_patch2$temperature_degC == 99999, ]
TARA_patch2 <- TARA_patch2 %>%
  filter(temperature_degC != 99999)
